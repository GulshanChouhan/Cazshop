<div class="bread_parent">
  <ul class="breadcrumb">
    ...
    <li><a href="<?php echo base_url('backend/superadmin/profile'); ?>"><b>My Profile</b> </a></li>    
  </ul>
</div>
      ...
      <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>"/>
         ...
         <div class="form-body label-static">
            <div class="col-md-10 center-block">
               ...
               <div class="form-group">
                  <label class="control-label col-md-4">Last Name<span class="mandatory">*</span> </label>
                  <div class="col-md-5">
                     <input type="text" placeholder="Last Name" class="form-control" name="lastname" value="<?php if(!empty($user->last_name)) echo $user->last_name ; ?>" data-bvalidator="required,alpha" data-bvalidator-msg="Last name is required and must be alphabate only"><?php echo form_error('lastname'); ?>
                  </div>
               </div>
               <div class="form-group">
