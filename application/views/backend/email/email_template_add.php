<div class="bread_parent">
   <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('backend/email_template/email_templates'); ?>">Email & SMS Template</a></li>
   ...
   <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post">
      <div class="form-body">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
               <textarea class="form-control" cols="100" rows="7" name="template_sms_body"></textarea><?php echo form_error('template_sms_body'); ?>
            </div>
         </div>
         <hr>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
               <textarea class="form-control" cols="100" rows="7" name="template_sms_body_admin"><?php echo set_value('template_sms_body_admin'); ?></textarea><?php echo form_error('template_sms_body_admin'); ?>
            </div>
         </div>
         <div class="form-group">
      ...
      <div class="form-actions fluid">
         <div class="col-md-offset-2 col-md-10">
            ...
            <a class="btn btn-danger" href="<?php echo base_url()?>backend/email_template/email_templates"><i class="icon-remove"></i> Cancel</a>               
         </div>
      </div>
   </form>
   <!-- END FORM--> 
