...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo base_url('backend/slider/sliders'); ?>">Home Page Setting</a></li>
     ...
     <li><a href=""><b>Edit Client Feedback</b> </a></li>
      ...
      <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post">
          ...
          <div class="form-body">
             <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" placeholder="Client Name" class="form-control" name="name" value="<?php if(!empty($feedback->name)){ echo $feedback->name; }else{ echo set_value('name'); } ?>"><?php echo form_error('name'); ?>
              </div>
            </div>  
            <div class="form-group">
              <label class="col-md-2 control-label">Designation and company name<span class="mandatory">*</span></label>
              <div class="col-md-9">
                <input type="text" placeholder="Eg : Hamptons Chamber of Commerce, Secretary" class="form-control" name="designation" value="<?php if(!empty($feedback->designation)){ echo $feedback->designation; }else{ echo set_value('designation'); } ?>"><?php echo form_error('designation'); ?>
              </div>
            </div>           
            <div class="form-group">
              <label class="col-md-2 control-label">Client Image<span class="mandatory">*</span></label>
              <div class="col-md-9">
                <?php if(!empty($feedback->client_image)){ ?> <img class="img_size" src="<?php echo base_url().$feedback->client_image;?>">  <?php }  ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <div class="input-group">
                  <textarea class="form-control" cols="100" rows="5" name="feedback" id="feedback" maxlength="230" placeholder="Provide the client feedback here..." ><?php if(!empty($feedback->feedback)){ echo $feedback->feedback; }else{ echo set_value('feedback'); }?></textarea>
                  <?php echo form_error('feedback'); ?>
                  <b>Please add the feedback in maximum 200 characters od maximum 30-35 words</b>
                </div>
              </div>
            </div>          
          </div>
