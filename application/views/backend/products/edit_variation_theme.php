...
<div class="bread_parent">
   <ul class="breadcrumb">
      ...
      <li><b>Edit Product Variation Theme</b></li>
   </ul>
</div>
<div class="col-sm-12">
   <div class="panel-body">
      <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post">
                  ...
                  <option value="">--Select Category--</option>
                   <?php 
                      ...
                      if(!empty($_GET['category'])) 
                        ...
                        $cate = $variation_themes->category;
         ...
         <div class="form-group atrributeData" style="<?php if($variation_themes->attributes){ ?>display: block;<?php }else{ ?>display: none;<?php } ?>">
            <label class="col-md-2 control-label">Choose Atrribute <span class="mandatory">*</span></label>
            <div class="col-md-9 attributesUsingCat">
               <?php 
                  echo getAttributeInfoUsingCat($variation_themes->category, $variation_themes->attributes);
               ?>
         ...
         <div class="form-group">
            ...
            <div class="col-md-9">
               <select class="form-control" name="status" >
                  <option value="1" <?php if(set_value('status')==1) echo 'selected'; else if($variation_themes->status==1) echo 'selected' ?> >Active</option>
                  <option value="2" <?php if(set_value('status')==2) echo 'selected'; else if($variation_themes->status==2) echo 'selected' ?> >Inactive</option>
               </select>
         ...
         <div class="form-actions fluid">
            <div class="col-md-offset-2 col-md-10">
               ...
               <a class="btn btn-danger" href="<?php echo base_url()?>backend/products/variation_themes">Back</a>
            </div>
         </div>
      </form>
      <!-- END FORM--> 
