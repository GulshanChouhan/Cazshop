...
<div class="panel-body no-padding-top">
   <header class="tabel-head-section">
      <form action="<?php echo base_url('backend/products/index') ?>" method="get" role="form" class="form-horizontal">
               ...
               <tbody>
                  <tr>
                     ...
                     <td>
                        <select name="seller_id" class="form-control">
                           ...
                           <?php 
                              ...
                              ?>
                           <option <?php if(!empty($_GET['seller_id'])){ if($row->user_id==$_GET['seller_id']){ echo "selected"; } } ?> value="<?php echo $row->user_id; ?>"><?php echo '<bold>'.ucwords($row->user_name).'</bold>&nbsp;&nbsp;&nbsp;[ '.$row->email.' ]'; ?></option>
                           <?php } ?>
                        </select>
                     </td>
                     <td>
                     ...
                     <td width="110"> 
                        ...
                        <a class="btn btn-danger tooltips" rel="tooltip" data-placement="top" data-original-title="Reset your product search" type="submit" href="<?php echo base_url('backend/products/index'); ?>"> <i class="icon icon-refresh"></i></a>
                     </td>
                  </tr>
               </tbody>
            </table>
      ...
      <table id="datatable_example" class="table-bordered responsive table table-striped table-hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <?php if($row->type_of_product==1){ ?>                     
                  <a href="<?php echo base_url().'backend/products/edit_product_category/'.$row->product_info_id.'/'.$row->product_variation_id.'/1'; ?>" class="btn btn-primary btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title=" View Product Details"><i class="fa fa-eye"></i>
                  </a>
                  <?php }else if($row->type_of_product==2){ ?>
                  ...
                  <?php } ?>
                  <a href="javascript:void(0);" onclick="return confirmBox('Are you sure want to delete ?','<?php echo base_url().'backend/products/delete_product/'.$row->product_info_id.'/'.$row->product_variation_id.'/1'; ?>')" class="btn btn-danger btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title="Delete Product"><i class="icon-trash "></i>
                  </a>
               </td>
            </tr>
            <?php } ?>
