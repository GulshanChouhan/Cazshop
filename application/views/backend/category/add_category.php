   ...
   <div class="col-md-8">
      <div class="panel-body">
         <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post">
            ...
            <header class="panel-heading colum"><i class="fa fa-angle-double-right"></i> Product Category Information :</header>
            <br>
            <div class="form-group">
               <label class="col-md-2 control-label">Category Name<span class="mandatory">*</span></label>
               <div class="col-md-9">
                  <input type="text" placeholder="Category Name" class="form-control" name="category_name" value="<?php echo set_value('category_name');?>" > <span class="error"><?php echo form_error('category_name'); ?> </span>
               </div>
            </div>
            <div class="form-group">
               <label class="col-md-2 control-label">Category Slug<span class="mandatory">*</span></label>
               <div class="col-md-9">
                  <input type="text" placeholder="Category Slug" class="form-control" name="category_slug" value="<?php echo set_value('category_slug');?>" > <span class="error"><?php echo form_error('category_slug'); ?> </span>
               </div>
            </div>
             <div class="form-group">
            ...
            <!--<div class="form-group">
               ...
               <div class="col-md-9">
                  <textarea class="form-control tinymce_edittor" name="description" ></textarea>
            ...
            <div class="form-group">
               ...
               <div class="col-md-9">
                  <select class="form-control" name="category_status" >
                     ...
                     ?>
                        <option value="<?php echo $key; ?>" <?php if(set_value('category_status')==$key) echo 'selected'; ?>><?php echo $value; ?></option>
                     <?php } ?>
                  </select>
