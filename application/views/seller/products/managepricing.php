                     ...
                     <div class="common-panel panel">
                        ...
                        <div class="panel-body">
                           <div class="col-sm-12 no-padding">
                              <form action="<?php echo base_url('seller/products/managePricing') ?>" method="get" role="form" class="form-horizontal">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <a class="btn btn-danger tooltips" rel="tooltip" data-placement="top" data-original-title="Reset your product search" type="submit" href="<?php echo base_url('seller/products/managePricing'); ?>"> <i class="icon icon-refresh"></i></a>
                                      </td>
                                  </tr>
                                  </tbody>
                                </table>
                                         ...
                                         <td class="image-td text-center">
                                          ...
                                          <td class="font-roboto text-center">
                                              ...
                                              ?>
                                                 <div class="input-group">
                                                    ...
                                                    <input class="form-control input-update-form" type="number"  maxlength="7" min="0" max="99999" id="sellprice<?php echo $row->product_variation_id; ?>" name="sellprice" placeholder="15.00" class="quantityNo" disabled="disabled" value="<?php if(!empty($row->sell_price)){ echo number_format($row->sell_price,2); }else{ echo 1; } ?>">

                                                    <a href="javascript:void(0)" class="tooltips updateSellPrice" attrId="<?php echo $row->product_variation_id; ?>" rel="tooltip" data-placement="top" data-original-title="Click to Edit Retail Price(MRP)">
                                                      <i class="fa fa-pencil" aria-hidden="true" id="iconSellPrice<?php echo $row->product_variation_id; ?>"></i>
                                                    </a>
                                          ...
                                          <td class="font-roboto text-center">
                                            ...
                                            ?>
                                               <div class="input-group">
                                                  <div class="input-group-addon">$</div>
                                                  <input class="form-control input-update-form" type="number"  maxlength="7" min="0" max="99999" id="base_price<?php echo $row->product_variation_id; ?>" name="base_price" placeholder="10.00" class="quantityNo" disabled="disabled" value="<?php if(!empty($row->base_price)){ echo number_format($row->base_price,2); }else{ echo 1; } ?>">

                                                  <a href="javascript:void(0)" class="tooltips updateBasePrice" attrId="<?php echo $row->product_variation_id; ?>" rel="tooltip" data-placement="top" data-original-title="Click to Edit Sell Price">
                                                    <i class="fa fa-pencil" aria-hidden="true" id="iconBasePrice<?php echo $row->product_variation_id; ?>"></i>
                                                  </a>
            ...
            swal({
                ...
                $.post('<?php echo base_url() ?>'+'backend/products/manage_product_status', {'type': '1', 'status': new_status, 'row_id': row_id}, function(data) {            
                   if(data.status==true){ 
                      ...
                      setTimeout(function() {
                        $(location).attr('href', '<?php echo base_url('seller/products/managePricing')?>');
                      }, 1000);
                   }else{       
