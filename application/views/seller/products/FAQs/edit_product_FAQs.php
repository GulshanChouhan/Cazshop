                  ...
                  <div class="col-sm-8 center-block">
                    <form autocomplete="off" role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post" data-bvalidator-validate>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input data-bvalidator="required" type="text" placeholder="Enter your question here" class="form-control" name="question" value="<?php if(set_value('question')) echo set_value('question'); else echo $product_faq->question; ?>" > <span class="error"><?php echo form_error('question'); ?> </span>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-4 control-label">Answer<span class="mandatory">*</span> :</label>
                        <div class="col-md-8">
                          <textarea data-bvalidator="required" class="form-control" placeholder="Enter your answer here" name="answer" rows="5" cols="10"><?php if(set_value('answer')) echo set_value('answer'); else echo $product_faq->answer; ?></textarea>
