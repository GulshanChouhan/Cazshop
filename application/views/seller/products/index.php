                  ...
                  <div class="">
                     <div class="common-panel panel">
                        ...
                        <div class="highlight-info-box">
                            <h4 class="color-red"> Welcome to the inventory experience!</h4>

                            <p>Products which are added/updated with proper and valid information are listed here. You are able to update the information and details of any product type (simple/variation) and it will show on the website according to your updation. please review the below given instructions to get more clarification about the inventory section.</p>

                            <ul>

                              <li>If any of your product is not appearing in the inventory section, then their is a possibility that it might be stored in the <a class="link-text" href="<?php echo base_url('seller/products/mydraft'); ?>"><b>Draft</b></a> section due to improper information.</li>

                              <li>If your product which is listed in the inventory but not showing on the website, then please make sure that it is activated on your end and approved by the admin as well. If the product is approved from the both end but still not displaying on website then please contact to <a class="link-text" href="<?php echo base_url('seller/support/messages'); ?>"><b>Support</b></a>.</li>

                              <li>Both types of products (simple/variation) are listed here. You are easily able to update the information of the simple product but in the case of variation products you can update the <b>Image</b> and <b>Offer</b> section  by clicking on edit of every individual variation which will be visible by expanding the parent product.</li>
                              <li>Type of the product is mentioned in the next of product title.</li>
                              <li>If you don't wish to continue with this product you can remove this product from the inventory.</li>
                            </ul> 
                        </div>
                        <div class="panel-body">
                           <div class="col-sm-12 no-padding">
                              <form action="<?php echo base_url('seller/products/index') ?>" method="get" role="form" class="form-horizontal">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        <div class="">
                                          <select name="product_type" class="form-control">                  
                                            ...
                                            <option value="1" <?php if(!empty($_GET['product_type']) && $_GET['product_type']=='1') echo 'selected'; ?>>Single</option> 
                                      ...
                                      <td>
                                        ...
                                        <a class="btn btn-danger tooltips" rel="tooltip" data-placement="top" data-original-title="Reset your product search" type="submit" href="<?php echo base_url('seller/products/index'); ?>"> <i class="icon icon-refresh"></i></a>
                                      </td>
                                      <td>
                                   ...
                                   <tbody>
                                      ...
                                      <tr>
                                         ...
                                         <td class="image-td text-center">
                                          ...
                                          <!-- <td class="text-center"><i class="fa fa-calendar-o" aria-hidden="true"></i> <?php //echo date('d M Y',strtotime($row->created_at)); ?>
                                          </td> -->
                                          <td class="text-center">
                                            <?php if($row->type_of_product==1){ ?>
                                               ...
                                               <a href="<?php echo base_url().'seller/products/shipment_rate/'.$row->product_info_id.'/'.$row->product_variation_id.'/1'; ?>" class="btn btn-info common-btn-xs btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title="Add/Update shipment rates"><i class="icofont icofont-cur-dollar" aria-hidden="true"></i>
                                               </a>
                                            ...
                                            <a href="javascript:void(0);" onclick="return confirmBox('Do you want to delete it ?','<?php echo base_url().'seller/products/delete_product/'.$row->product_info_id.'/'.$pvID.'/1'; ?>')" class="btn btn-danger btn-xs common-btn-xs delete-btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title="Delete Product"><i class="icon-trash "></i>
                                            </a>
