                     ...
                     <div class="">
                        <div class="common-panel panel">
                           <div class="panel-heading">
                              <div class="panel-title"><i class="icofont icofont-live-support"></i> Support System</div>
                           </div>
                                                      ...
                                                      <div class="message-block <?php if($row->support_id==$message_id){ echo'info';}?>">
                                                         <div class="header-block">
                                                            <div class="ticket-title pull-left">
                                                               <i class="fa fa-ticket"></i>&nbsp;  Ticket ID :<b><a href="<?php echo base_url().'seller/support/messages/'.$row->support_id ?>">
                                                               #<?php echo $row->support_id; ?></a></b>
                                                            </div>
                                                            <div class="pull-right">
                                                               <a href="<?php echo base_url().'seller/support/messages/'.$row->support_id ?>" class="btn btn-xs btn-orange"> View Ticket</a>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                         </div>
                                                            ...
                                                            <div class="pull-left">
                                                               <div class="subject-text">
                                                                  <?php  
                                                                     ...
                                                                     ?> 
                                                                  <span class="message-headings">Subject :</span> <a href="<?php echo base_url().'seller/support/messages/'.$row->support_id ?>"><?php if(!empty($row->reason)){ echo $feedback_subject_status; } ?></a>
                                                               </div>
                                                               <div class="message-text">
                                                                  <span class="message-headings">Message :</span> <a href="<?php echo base_url().'seller/support/messages/'.$row->support_id ?>">
                                                                  <?php if(!empty($row->message)){ echo character_limiter($row->message,60); } ?></a>
                                                               </div>
                                                               <?php if(get_unread_msg($row->support_id,seller_id())){?>
                                                               <a href="<?php echo base_url().'seller/support/messages/'.$row->support_id ?>" style="color: red;">New Message Received </a>
                                                               <?php }?>
                                                            </div>
                                                            <div class="date-info">
                                       ...
                                       <div class="dashboard-tab-sub-warp">
                                          ...
                                          <form action="<?php echo current_url() ?>" method="post" id="form_valid">
                                             <div class="chats-text">
                                                <textarea name="reply" data-bvalidator="required" class="form-control tooltips" maxlength="500" rel="tooltip" data-placement="top" id="msg_reply" placeholder="Type your message here" rows="4" cols="33" data-bvalidator="required,maxlen[500]" data-bvalidator-msg="" data-bvalidator-modifier="trim"><?php echo set_value('reply'); ?></textarea>
                                                <p class="required"><?php echo form_error('reply') ?></p>
                                             </div>
                                             <div class="pull-left"> 
                                             ...
                                             <button class="btn btn-primary pull-right submit-reply" type="submit">Submit</button>
                                             <div class="clearfix"></div>
                                          </form>
                                          <?php }else{ ?>
