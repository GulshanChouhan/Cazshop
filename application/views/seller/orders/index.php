...
<div class="bread_parent">
   <ul class="breadcrumb">
      ...
      <li><b>List Of <?php echo ucfirst($title); ?> <?php if($status){ ?> Orders<?php } ?></b></li>
   </ul>
                     ...
                     <div class="common-panel panel">
                        <div class="panel-body">
                           <div class="col-sm-12 no-padding">
                              <form action="<?php echo base_url('seller/orders/index/'.$status) ?>" method="get" role="form" class="form-horizontal">
                                <table class="responsive table_head common-table-top-section" cellpadding="5">
                                  <thead>
                                    <tr>
                                      <th width="20%">Product Title</th>
                                      <th width="20%">Order ID</th>
                                      <th width="30%">Buyer Infomation</th>
                                      <?php if(empty($status)){ ?>
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <a class="btn btn-danger tooltips" rel="tooltip" data-placement="top" data-original-title="Reset your order search" type="submit" href="<?php echo base_url('seller/orders/index/'.$status) ?>"> <i class="icon icon-refresh"></i></a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                   ...
                                   <thead class="thead_color">
                                      <tr>
                                         ...
                                         <?php if($status==4){ ?>
                                           ...
                                           <th width="18%">Buyer Information</th>
                                           <th width="10%">Grand Total</th>
                                           <th width="10%" class="text-center">Status</th>
                                           <th width="10%">Admin Confirmation</th>
                                   ...
                                   <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td class="text-center">
                                             <div class="btn-group">
                                                <button data-toggle="dropdown" type="button" class="btn btn-xs btn-<?php if(!empty($row->order_status)) echo orderStatuscls($row->order_status); else echo "primary"; ?> dropdown-toggle">
                                                  <?php
                                          ...
                                          <td>
                                            <?php if($row->admin_delivered_confirmation==0){ ?>
                                              <span class="btn btn-danger btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title="Please contact to administrator to confirm this order as delivered">Not Delivered</span>
                                            <?php }else{ ?>
                                              <span class="btn btn-success btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title="Admin confirmed to delivered the order successfully">Delivered</span>
                                            <?php } ?>
                                          </td>
                                          <?php } ?>
                                          <td>
            ...
            swal({
               ...
               //alert(data);          
                   if(data.status==true){ 
                      ...
                      setTimeout(function() {
                        $(location).attr('href', '<?php echo base_url('seller/orders/index/'.$status); ?>');
                      }, 2000);                   
                   }else{       
