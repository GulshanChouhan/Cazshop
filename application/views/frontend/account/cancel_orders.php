					      	...
					      	<div class="order-common-panel">
			        			...
			        			<?php 
	        						...
	        						foreach ($orderDetailIDs as $key => $value) {
	        							...
	        							$order_status  = getRow('order_status', array('order_detail_id'=>$value, 'status'=>5));
				        						...
				        						<div class="a-row">
				        							<div class="order-item-box clearfix">
				        								...
				        								<div class="order-item-right">
				                                            ...
				                                            <div class="clearfix"></div>
				                                            <div class="a-row">
				                                                <div class="left-label">Cancelled Date:</div>
				                                                <div class="right-label"><?php if($order_status->created) echo date('d M Y',strtotime($order_details->created)); else echo "-"; ?></div>
				                                            </div>
															<div class="a-row">
															...
															<div class="a-row">
				                                                ...
				                                                <div class="right-label"><span class="dollar-icon-bold">
				                                                	<?php echo getCurrencyIcon($row->currency_type); ?>
				                                                </span><span class="number-icon-bold">
				                                                <?php
					      	...
					      	<div class="col-md-12">
					      		...
					      		<div class="noresult-block text-center">
				                    ...
				                    <div class="noresult-content">
				                        <h4>Cancelled orders not available</h4>
				                    </div>
				                </div>
					      	</div>
					      	<?php } ?>
